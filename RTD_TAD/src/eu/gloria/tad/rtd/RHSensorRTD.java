 ...
 *
 */
public class RHSensorRTD extends WeatherRTDBasedOnXml implements RTDRHSensorInterface {

	public RHSensorRTD(String deviceId) throws RTException {
		super(deviceId);
	...
	public Device devGetDevice(boolean allProperties) throws RTException {
		...
		RunTimeCounter rtc = new RunTimeCounter("RHSensorRTD", this.getDeviceId());
		rtc.start();
		...
		try{
			...
			dev.setMeasureUnit(MeasureUnit.PERCENT);	

...
/**
 * Device Discoverer for TAD Telescope.
 * 
 * @author jcabello
 *
 */
public class DeviceDiscoverer implements DeviceDiscovererInterface {
	...
	public RTDDeviceInterface getRTD(String deviceId) throws RTException {
		...
		try{
			...
			try {
				iniConfObj = new HierarchicalINIConfiguration("rtd_tad_discovery.ini");
			} catch (ConfigurationException e) {
				e.printStackTrace();
				throw new RTException("DeviceDiscoverer. Impossible to load the file: rtd_tad_discovery.ini");
			}
